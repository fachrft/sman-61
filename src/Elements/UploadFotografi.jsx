...
import fotograsi from "../assets/fotografi.png";
import fotografiText from "../assets/fotografi-text.png";
...
const UploadFotografi = () => {
    ...
    const uploadFoto = async (e) => {
        ...
        try {
            ...
            const response = await axiosJWT.post("https://sman-61-server.vercel.app/gallery", formData, {
                headers: {
    ...
    return (
        <div className="background">
            ...
            <div className="flex flex-col justify-center items-center">
                <div>
                    <img src={fotograsi} alt="" />
                </div>
                <div>
                    <img src={fotografiText} alt="" />
                </div>
            </div>
...
export default UploadFotografi;
